# EduGuard system — Legacy Frontend Copy

This folder is retained as a legacy copy of the frontend during the repository split.

Use [frontend/](../..) as the canonical frontend root.
...
See the [MDM architecture note](../../../docs/architecture-mdm.md) and [root architecture note](../../../docs/architecture.md) for high-level notes.
